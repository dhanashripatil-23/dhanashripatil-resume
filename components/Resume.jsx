...
import { EnvelopeIcon, LinkIcon, PhoneIcon, ArrowDownTrayIcon, CodeBracketIcon } from "@heroicons/react/24/outline";
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="flex justify-end mb-6 sm:mb-8">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="group relative flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-cyan-600 to-emerald-600 text-white rounded-lg font-mono text-sm sm:text-base font-semibold overflow-hidden transition-all duration-300 disabled:opacity-50"
          >
        ...
        >
          ...
          <div className="text-center mb-8 sm:mb-10 pb-6 sm:pb-8 border-b border-cyan-500/30 relative">
            ...
            <motion.p 
              ...
              className="text-lg sm:text-xl md:text-2xl text-cyan-300 font-mono mb-4 sm:mb-6"
            >
              <span className="text-emerald-400">const</span> <span className="text-cyan-400">role</span> = <span className="text-emerald-300">"Software Test Engineer"</span>;
            </motion.p>
            ...
            <motion.div 
              ...
              className="flex flex-wrap justify-center gap-3 sm:gap-4 text-xs sm:text-sm text-gray-300 font-mono"
            >
              <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-900/50 rounded border border-cyan-500/20 hover:border-cyan-500/40 transition-colors">
                <span className="text-emerald-400">📍</span>
                <span>Virar, Maharashtra, India</span>
              </div>
              <a 
                href="mailto:patil.dhanuu23@gmail.com"
                className="flex items-center gap-2 px-3 py-1.5 bg-gray-900/50 rounded border border-cyan-500/20 hover:border-cyan-500/40 hover:text-cyan-400 transition-all"
              >
          ...
          <section className="mb-8 sm:mb-10 relative">
            ...
            <div className="pl-4 sm:pl-6 border-l-2 border-cyan-500/30">
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base md:text-lg font-mono">
                <span className="text-emerald-400">Results-oriented</span> software test engineer with expertise in automation and manual testing, 
                passionate about ensuring <span className="text-cyan-400">robust and reliable</span> software releases through rigorous analysis 
                and collaborative teamwork. Skilled in tools like <span className="text-emerald-300">Cypress</span> and <span className="text-emerald-300">Selenium</span>, with a knack for 
                ...
                During a recent career break, proactively upskilled in <span className="text-cyan-400">artificial intelligence (AI)</span> 
          ...
          <section className="mb-8 sm:mb-10">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-3 gap-2">
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-cyan-300 font-mono">
                  <span className="text-emerald-400">const</span> careerBreak = <span className="text-cyan-400">"Full-time Parenting"</span>;
                </h3>
                <span className="text-emerald-400 font-mono text-xs sm:text-sm md:text-base bg-emerald-500/10 px-2 py-1 rounded border border-emerald-500/30">
                  Nov 2022 - Present
                </span>
              </div>
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base font-mono">
                ...
                renewed energy and a commitment to upskilling in the latest technologies and <span className="text-cyan-400">AI</span>, ready 
            ...
            >
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-3 gap-2">
                <div>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-cyan-300 font-mono">
                    <span className="text-emerald-400">class</span> <span className="text-cyan-400">SoftwareTestEngineer</span>
                  </h3>
                  <p className="text-emerald-400 font-mono text-base sm:text-lg mt-1">TechBuzz</p>
                </div>
                <div className="text-right sm:text-left sm:text-right">
                  <span className="text-cyan-400 font-mono text-xs sm:text-sm md:text-base block bg-cyan-500/10 px-2 py-1 rounded border border-cyan-500/30 inline-block">
                    May 2020 - Jul 2021
                  </span>
                  <span className="text-gray-400 text-xs sm:text-sm font-mono block mt-1">1 yr 3 mos • On-site</span>
                </div>
              </div>
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base mb-4 font-mono">
                ...
                <span className="text-emerald-300"> Selenium</span> and <span className="text-emerald-300">Appium</span>, with a commitment to improving testing processes and delivering 
                reliable, user-friendly software solutions.
              </p>
              <div className="flex flex-wrap gap-2 mt-4">
                {["Software Testing", "Adhoc Testing", "Selenium", "Appium"].map((skill) => (
                  <span key={skill} className="px-3 py-1.5 bg-cyan-500/10 text-cyan-300 rounded border border-cyan-500/30 text-xs sm:text-sm font-mono hover:bg-cyan-500/20 hover:border-cyan-500/50 transition-all">
                    {skill}
                  </span>
                ))}
              </div>
            ...
            >
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-3 gap-2">
                <div>
                  ...
                  <p className="text-emerald-400 font-mono text-base sm:text-lg mt-1">Integration Wizards Solutions Private Limited</p>
                </div>
                <div className="text-right sm:text-left sm:text-right">
                  <span className="text-cyan-400 font-mono text-xs sm:text-sm md:text-base block bg-cyan-500/10 px-2 py-1 rounded border border-cyan-500/30 inline-block">
                    Apr 2018 - May 2020
                  </span>
                  <span className="text-gray-400 text-xs sm:text-sm font-mono block mt-1">2 yrs 2 mos • Remote</span>
                </div>
              </div>
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base mb-4 font-mono">
              ...
              <div className="mt-4 mb-4 pl-4 border-l-2 border-emerald-500/20">
                <p className="text-xs sm:text-sm text-emerald-400 font-mono font-semibold mb-2">// Previous Role:</p>
                <div className="pl-3 sm:pl-4 border-l-2 border-emerald-500/30">
                  <p className="text-cyan-300 font-mono font-medium text-sm sm:text-base">Associate Software Test Engineer</p>
                  <p className="text-gray-400 text-xs sm:text-sm font-mono mb-2">Oct 2017 - Apr 2018</p>
                  <p className="text-gray-300 text-xs sm:text-sm leading-relaxed font-mono">
                    ...
                    user-friendly products. Proficient in <span className="text-emerald-300">Selenium</span>, <span className="text-emerald-300">Cypress</span>, and industry-standard QA practices.
                  </p>
                </div>
              </div>
              <div className="flex flex-wrap gap-2 mt-4">
                {["Data Structures", "Test Automation", "Cypress", "Selenium"].map((skill) => (
                  <span key={skill} className="px-3 py-1.5 bg-emerald-500/10 text-emerald-300 rounded border border-emerald-500/30 text-xs sm:text-sm font-mono hover:bg-emerald-500/20 hover:border-emerald-500/50 transition-all">
                    {skill}
                  </span>
                ))}
              </div>
          ...
          <section className="mb-8 sm:mb-10">
            ...
            >
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-cyan-300 font-mono mb-2">
                <span className="text-emerald-400">const</span> <span className="text-cyan-400">degree</span> = <span className="text-emerald-300">"Bachelor of Engineering"</span>;
              </h3>
              <p className="text-emerald-400 font-mono text-sm sm:text-base mb-1">VIVA Institute of Technology</p>
              <p className="text-gray-400 text-xs sm:text-sm font-mono">Mumbai University • Jun 2017</p>
            </motion.div>
            ...
            >
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-cyan-300 font-mono mb-2">
                <span className="text-emerald-400">const</span> <span className="text-cyan-400">diploma</span> = <span className="text-emerald-300">"Diploma - EECE"</span>;
              </h3>
              <p className="text-emerald-400 font-mono text-sm sm:text-base mb-1">
                Pravin Rohidas Patil College of Diploma Engineering & Technology
              </p>
              <p className="text-gray-400 text-xs sm:text-sm font-mono">Maharashtra State Board of Technical Education • May 2014</p>
            </motion.div>
            ...
            >
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-cyan-300 font-mono mb-2">
                <span className="text-emerald-400">const</span> <span className="text-cyan-400">ssc</span> = <span className="text-emerald-300">"Secondary School Certificate"</span>;
              </h3>
              <p className="text-emerald-400 font-mono text-sm sm:text-base">Aryan High School</p>
            </motion.div>
          </section>
          ...
          <section className="mb-8 sm:mb-10">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-3 gap-2">
                <h3 className="text-base sm:text-lg md:text-xl font-bold text-cyan-300 font-mono">
                  <span className="text-emerald-400">function</span> <span className="text-cyan-400">differentialRelay</span>() <span className="text-gray-500">{"{"}</span>
                </h3>
                <span className="text-emerald-400 font-mono text-xs sm:text-sm bg-emerald-500/10 px-2 py-1 rounded border border-emerald-500/30">
                  Aug 2016 - May 2017
                </span>
              </div>
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base font-mono pl-4 border-l-2 border-gray-800">
            ...
            >
              {[
                ...
                <motion.span
                  ...
                  className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-cyan-500/10 to-emerald-500/10 text-cyan-300 rounded border border-cyan-500/30 text-xs sm:text-sm font-mono hover:from-cyan-500/20 hover:to-emerald-500/20 hover:border-cyan-500/50 hover:text-cyan-200 transition-all cursor-default"
                >
                  {skill}
                </motion.span>
              ))}
        ...
        <motion.p 
          ...
          className="text-center text-gray-500 mt-8 sm:mt-10 text-xs sm:text-sm font-mono"
        >
          <span className="text-cyan-400">//</span> Built with <span className="text-emerald-400">Next.js 14</span> + <span className="text-cyan-400">TailwindCSS</span> • Professional Resume Portfolio
        </motion.p>
      </div>
    </div>
  );
